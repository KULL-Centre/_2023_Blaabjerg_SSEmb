#The code presented in this file has been taken from: 
...
def _norm_no_nan(x, axis=-1, keepdims=False, eps=1e-4, sqrt=True):
    '''
...
class GVPConv(MessagePassing):
    ...
    def __init__(self, in_dims, out_dims, edge_dims,
                 ...
                 activations=(F.leaky_relu, torch.sigmoid), vector_gate=False):
...
class GVPConvLayer(nn.Module):
    ...
    def __init__(self, node_dims, edge_dims,
                 ...
                 activations=(F.leaky_relu, torch.sigmoid), vector_gate=True, aggr="mean"):
