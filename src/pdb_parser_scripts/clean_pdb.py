...
def clean_pdb(pdb_input_filename: str, out_dir: str):
    """
    Function to clean pdbs using pdbfixer.
...
if __name__ == "__main__":
    ...
    # Clean 
    clean_pdb(pdb_input_filename, out_dir)
